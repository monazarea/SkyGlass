...
struct WeatherMapper {
    ...
    static func map(response: WeatherResponse) -> WeatherEntity {
        return WeatherEntity(
            ...
            conditionIconUrl: response.current.condition.icon.withHttpPrefix(), conditionCode: response.current.condition.code,
    ...
    private static func mapDay(_ forecastDay: ForecastDay) -> DayEntity {
        return DayEntity(
            ...
            conditionIconUrl: forecastDay.day.condition.icon.withHttpPrefix(), conditionCode: forecastDay.day.condition.code,
    ...
    private static func mapHour(_ hourlyForecast: HourlyForecast) -> HourEntity {
        return HourEntity(
            ...
            conditionIconUrl: hourlyForecast.condition.icon.withHttpPrefix(), conditionCode: hourlyForecast.condition.code
        )
    }
